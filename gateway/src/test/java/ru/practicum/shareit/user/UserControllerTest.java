...
public class UserControllerTest {
    ...
    void addUserTest() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(1L, "Name", "name@gmail.com");
    ...
    void addUserWrongEmailTest() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(1L, "Name", "namegmail.com");
        String userJson = objectMapper.writeValueAsString(userDto);
        ResponseEntity<Object> response = new ResponseEntity<>(userJson, HttpStatus.OK);
        when(userClient.postUser(any())).thenReturn(response);
        mockMvc.perform(
        ...
        userJson = objectMapper.writeValueAsString(new UserDtoRequest(null, "Noname", null));
    ...
    void testPathUser() throws Exception {
        UserDtoRequest userDto = new UserDtoRequest(1L, "Name", "name@gmail.com");
        UserDtoRequest userDtoUpdate = new UserDtoRequest(1L, "Noname", "noname@gmail.com");
