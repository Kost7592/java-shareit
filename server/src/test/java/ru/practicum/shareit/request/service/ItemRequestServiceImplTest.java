...
public class ItemRequestServiceImplTest {
    ...
    void getRequestInformationWrongRequestTest() {
        ...
        NotFoundException ex = assertThrows(NotFoundException.class, () -> itemRequestService.getItemRequest(1L, user.getId()));
    ...
    public void getAllRequestValidInputReturnsListTest() {
        ...
        when(mockItemRequestRepository.findAllByRequestorIdIsNot(userId,
                page))
        ...
        itemRequestDto.setRequestor(new UserForItemRequestDto(requesterDto.getId(), requesterDto.getName()));
